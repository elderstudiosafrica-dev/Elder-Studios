...
export default function Trailer() {
  return (
    <section
      id="trailer"
      className="relative overflow-hidden px-6 pb-32 pt-10 md:px-16 md:pb-44 md:pt-14"
    >
      <div className="relative mx-auto max-w-[1500px]">
        ...
        <Reveal>
          <div className="relative mx-auto aspect-video w-full max-w-310 overflow-hidden shadow-[0_36px_90px_-26px_rgba(0,0,0,0.95)]">
            <YouTubeLite id={game.youtubeId} title="Veiled - Official Trailer" />
          </div>
        </Reveal>

        <Reveal delay={0.15}>
          <p className="mx-auto mt-14 max-w-[1360px] text-center font-display text-xl uppercase leading-[0.98] text-mist-dim sm:mt-24 sm:text-3xl md:mt-32 md:text-[3.25rem]">
            {game.description}
          </p>
        </Reveal>
      </div>
